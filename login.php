	...
	<div class="container">
			...
			<div class="signin-signup">
				<form action="dblogin.php" class="sign-in-form" method="POST">
					...
					<div class="input-field">
						...
						<input type="password" id="loginPassword" placeholder="Kata Sandi" name="password" required onkeyup="hideAlertBox()" />
						<i class="fas fa-eye-slash" id="toggleLoginPassword" style="cursor: pointer;"></i>
					</div>
					<input type="submit" value="Masuk" class="submit solid" id="loginButton" />
 	        ...
 	        Email atau Kata Sandi salah.
				...
				<form action="dbregister.php" class="sign-up-form" method="POST" id="registerForm">
					...
					<div class="input-field">
						...
						<input type="text" placeholder="Nama Depan" name="firstName" onkeyup="hideAlertBox()" required />
					</div>
					<div class="input-field">
						<i class="fas fa-user"></i>
						<input type="text" placeholder="Nama Belakang" name="lastName" onkeyup="hideAlertBox()" required />
					</div>
					<div class="input-field">
						<i class="fas fa-envelope"></i>
					...
					<div class="input-field">
						...
						<input type="text" placeholder="No Kontak" name="contact" onkeyup="hideAlertBox()" required />
					</div>
					<div class="input-field">
						<i class="fas fa-lock"></i>
						<input type="password" id="registerPassword" placeholder="Kata Sandi" name="password" required onkeyup="hideAlertBox()" />
						<i class="fas fa-eye-slash" id="toggleRegisterPassword" style="cursor: pointer;"></i>
					</div>
					<input type="submit" class="submit" value="Daftar" id="registerButton" />
		...
		<div class="panels-container">
			<div class="panel left-panel">
				<div class="content">
					<h3>Baru di Restoran Kami?</h3>
					<p>
						Bergabunglah dengan kami hari ini dan nikmati kemudahan pemesanan online. Dapatkan penawaran eksklusif dan lacak pesanan Anda dengan mudah.
					</p>
			...
			<div class="panel right-panel">
				<div class="content">
					...
					<p>
						Masuk untuk terus menikmati hidangan lezat kami dan mengelola pesanan Anda dengan lancar.
					</p>
