...
<body>
  ...
  <div class="title mb-4">
    <h3>Halo <?php echo $user['firstName'] . " " . $user['lastName']; ?>, ini keranjang Anda!</h3>
  </div>

  <div class="cart-details ">
    <div class="cart-items">
      <h4 class="mt-2">Daftar Item</h4>
      <hr>
      <ul class="list-group">
            ...
            <li class="d-flex justify-content-between align-items-center mb-3 list-group-item">
              ...
              <div class="mt-1">
                <div class="d-flex flex-row justify-content-between align-items-start quantity-price">
                  <div>
                    Rp <span class="item-price"><?= $item['price'] ?></span> x <span class="item-quantity"><?= $item['quantity'] ?></span>
                  </div>
                </div>
    ...
    <div class="order-summary">
      ...
      <div class="summary-details payment">
        ...
        <div>
          ...
          <label for="Takeaway">Ambil di tempat</label>
        </div>
        <div>
      ...
      <form id="checkout-form" action="order_review.php" method="post">
        ...
        <button type="button" id="checkout-button">Bayar (Checkout)</button>
      </form>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function updateQuantity(element, change, isInput = false) {
        ...
        itemContainer.querySelector('.item-total-price').textContent = 'Rp ' + itemTotalPrice;
